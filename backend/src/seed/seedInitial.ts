...
export class InitSystemData002 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      INSERT INTO public.sys_class_inher (inher_uid, metaclass_uid, parent_uid, child_uid, created_at)
      VALUES
      ...
      ON CONFLICT (inher_uid) DO NOTHING;
    `);
  }
